...
class Content extends Component {
  showContent = () => {
    ...
    switch (actualIndex) {
      ...
      case 23: return( <Page23 dataPage = { data.page23 } endActivities = { endActivities[23] } checkEndActivity = { checkEndActivity } checkEnabledUnit = { checkEnabledUnit } checkEndUnit = { checkEndUnit } /> );


      case 24: return( <Page24 dataPage = { data.page24 } endActivities = { endActivities[22] } checkEndActivity = { checkEndActivity } checkEnabledUnit = { checkEnabledUnit } checkEndUnit = { checkEndUnit } /> );

      case 25: return( <Page25 dataPage = { data.page25 } endActivities = { endActivities[25] } checkEndActivity = { checkEndActivity } checkEnabledUnit = { checkEnabledUnit } checkEndUnit = { checkEndUnit } /> );



      // // END --------------------------------------------------------------------------------
      case 26: return( <BackCover dataPage = { data.page26 } /> );
